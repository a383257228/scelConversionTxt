...
if __name__ == '__main__':
    ...
    o = ['11.scel', u'ｊａｖａ常用.scel', u'linux少量术语.scel', u'oracle数据库.scel', u'编程开发.scel', u'编程语言.scel', u'程序猿词库.scel',
         u'电脑软件分类词库.scel', u'机器学习.scel', u'计算机词汇.scel', u'计算机类.scel', u'计算机专业词汇大全.scel', u'开发词条.scel', u'人工智能词库.scel',
         u'软件专业.scel', u'万能计算机词库.scel', u'专业计算机词汇.scel', u'自然语言处理及计算语言学相关术语.scel']
